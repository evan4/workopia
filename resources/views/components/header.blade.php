...
<nav class="bg-gray-800">
    ...
    <div class="relative flex h-16 items-center justify-between">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        <div class="flex shrink-0 items-center">
          <a href="{{url('/')}}">
            <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">Workopia</span>
          </a>
        </div>
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        ...
        <div class="relative ml-3">
          ...
          -->
          <div class="absolute hidden right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 ring-1 shadow-lg ring-black/5 focus:outline-hidden" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
  ...
  <div class="hidden" id="mobile-menu">
    <div class="space-y-1 px-2 pt-2 pb-3">
      ...
      <x-nav-link url="/jobs" :active="request()->is('jobs')" menuItem="1" :mobile="true">All Jobs</x-nav-link>
      <x-nav-link url="/jobs/saved" :active="request()->is('jobs/saved')" menuItem="2" :mobile="true">Save Jobs</x-nav-link>
